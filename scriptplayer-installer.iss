...
[Files]
Source: "ScriptPlayer\bin\{#Configuration}\ScriptPlayer.exe"; DestDir: "{app}"
Source: "ScriptPlayer\bin\{#Configuration}\*.dll"; DestDir: "{app}"
Source: "ScriptPlayer\bin\{#Configuration}\*.config"; DestDir: "{app}"
...
Root: HKLM; Subkey: "SOFTWARE\Classes\AppID\ScriptPlayer.exe"; ValueType:string; ValueName: "AppID"; ValueData: "{{415579bd-5399-48ef-8521-775ebcd647af}"; Flags: uninsdeletekey
